...
$logFile = Join-Path $logDirectory ("scheduled_{0}.log" -f $Mode)
...
Add-Content -LiteralPath $logFile -Encoding UTF8 -Value ("[{0}] END mode={1} exit={2}" -f $finishedAt, $Mode, $captureExitCode)
