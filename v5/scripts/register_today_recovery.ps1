...
$settings=New-ScheduledTaskSettingsSet -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries -WakeToRun -ExecutionTimeLimit (New-TimeSpan -Minutes 8) -RestartCount 2 -RestartInterval (New-TimeSpan -Minutes 2)
