...
$temporary="$ownership.$PID.tmp";$value|ConvertTo-Json|Set-Content -LiteralPath $temporary -Encoding utf8;Move-Item -LiteralPath $temporary -Destination $ownership -Force
