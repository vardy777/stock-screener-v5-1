...
class CandidateFunnel:
    ...
    def run(self,snapshot,*,market_state_id:str,market_valid:bool,stage:str,allowed_codes:Iterable[str]|None=None,baseline_candidates:Iterable[dict]|None=None)->CandidateFunnelV1:
        ...
        parameters={"min_amount":self.policy.min_amount,"max_candidates":self.policy.max_candidates,"maximum_intraday_change":self.policy.maximum_intraday_change,"maximum_range":self.policy.maximum_range,"momentum_weight":.45,"liquidity_weight":.30,"close_location_weight":.25,"confirmation_reuses_morning_rank":True}
