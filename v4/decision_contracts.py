...
_REASON_TEXT = (
    ...
    ("盘口", DecisionReason.QUOTE_INVALID),
    ("停牌", DecisionReason.QUOTE_INVALID),
    ("涨跌停", DecisionReason.QUOTE_INVALID),
    ("过热", DecisionReason.SCORE_POLICY),
    ("MA10", DecisionReason.SCORE_POLICY),
    ("成交额", DecisionReason.QUOTE_INVALID),
