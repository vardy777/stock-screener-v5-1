...
def facts(root):
    ...
    (root/"acquisition"/day/"a.json").write_text(json.dumps({"accepted":True,"stage":"morning","requested_at":f"{day}T09:25:00+08:00"}),encoding="utf-8")
    (root/"acquisition"/day/"b.json").write_text(json.dumps({"accepted":True,"stage":"signal","requested_at":f"{day}T14:49:00+08:00"}),encoding="utf-8")
